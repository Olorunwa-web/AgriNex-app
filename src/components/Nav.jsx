...
const Nav = () => {
    ...
    return (
        <>
           <nav className = 'fixed left-1/2 top-0 w-11/12 max-w-8xl md:mt-7 flex flex-col mt-5 -translate-x-1/2 bg-white bg-background/20 rounded-3xl md:rounded-full z-50 backdrop-blur-lg '>
