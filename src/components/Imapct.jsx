        ...
        <>
            <section className = 'my-9'>
                <section className = 'container mx-auto px-4 md:px-8'>
                  <p className = 'text-center font-normal text-[#808080] text-[1rem] md:text-[1rem]  mb-1'>PROOF IN PROGRESS</p>
                  <h1 className = 'text-center text-[1.4rem] md:text-[1.7rem] lg:text-[2rem] font-bold mb-4 text-[#0D0D0D]'>Our Imapact in Numbers</h1>
                        ...
                        <div className = 'lg:w-1/2 w-full flex justify-center lg:justify-start xl:justify-center  '>
                            <div className = 'w-[75%] flex items-center md:w-[78%] lg:w-full '>
                              <div className = 'w-full flex flex-wrap  md:justify-between gap-y-7 lg:gap-x-5 lg:gap-y-5 xl:gap-x-7 xl:gap-y-13 '>
                               {impacts.map((imp) => {
                                   return (
                                       <div key = {imp.id} className = 'w-full md:justify-start md:w-[40%] lg:w-[46%] xl:w-[48%] flex gap-3' >
                                           <div>
                                           ...
                                           <div className = 'flex flex-col'>
                                               <h1 className = 'font-semibold text-[1.4rem] md:text-[1.8rem] text-[#3A3A3A] '>{imp.number}</h1>
                                               <p className = 'font-semibold text-[1rem] text-[#808080] '>{imp.board}</p>
                                           </div>
                                       </div>
                                   )
                               })}
