    ...
    return (
        <>
            <section className = 'container mx-auto px-4 md:px-8 '>
                <section>
                   <p className = 'text-center font-normal text-[#808080] text-[1rem] md:text-[1rem]  mb-1'>NEED HELP?</p>
                   <h1 className = 'text-center text-[1.4rem] md:text-[1.7rem] lg:text-[2rem] font-bold mb-4 text-[#0D0D0D]'>FAQs</h1>
                           ...
                           <div key = {faqs.id} onClick={() => toggleAccordion(index)} className={` border-b-1 border-[#E4E4E4]  ${activeIndex === index ? 'border-b-1 border-[#E4E4E4] pb-2 md:pb-0' : 'py-4'}`}>
                               <div>
                                   <div className = 'flex justify-between items-center'>
                                      <h1 className={`font-semibold md:text-[1.4rem] text-[1.2rem] ${activeIndex === index ? 'text-[#4CAF50]' : 'text-[#0D0D0D]'}`} >{faqs.title}</h1>
                                  ...
                                  >
                                      <p className = ' font-normal text-[1rem] text-[#808080]'>{faqs.content}</p>
                                  </div>
                               </div>
                           </div>
                           )
